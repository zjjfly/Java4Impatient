...
public class Exercise {
    ...
    public void exer3() throws Exception {
        File gradleConfig = new File("./gradlew.bat");
        File[] files = new Exercise().selectFileBySuffix("./", "bat");
        assertArrayEquals(new File[]{gradleConfig}, files);
    }

    @Test
    public void exer4() throws Exception {
        File gradleScript = new File("./build.gradle");
        File java = new File("./src/test/java");
        File gradleSetting = new File("./setting.gradle");
